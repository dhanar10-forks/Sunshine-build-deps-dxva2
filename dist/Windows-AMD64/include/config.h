...
#define FFMPEG_CONFIGURATION "--prefix=/z/Git/Sunshine-build-deps-dxva2/build/FFmpeg --pkg-config=/c/msys64/usr/bin/pkg-config.exe --extra-cflags=' -w' --extra-cxxflags=' -w' --cc='C:/msys64/ucrt64/bin/cc.exe' --cxx='C:/msys64/ucrt64/bin/c++.exe' --ar='C:/msys64/ucrt64/bin/ar.exe' --ranlib='C:/msys64/ucrt64/bin/ranlib.exe' --pkg-config-flags=--static --extra-cflags=-I/z/Git/Sunshine-build-deps-dxva2/build/usr/local/include --extra-cflags=-I/z/Git/Sunshine-build-deps-dxva2/build/x264/include --extra-ldflags=-L/z/Git/Sunshine-build-deps-dxva2/build/usr/local/lib --extra-ldflags=-L/z/Git/Sunshine-build-deps-dxva2/build/x264/lib --extra-libs='-lpthread -lm' --disable-all --disable-autodetect --disable-iconv --enable-gpl --enable-static --enable-avcodec --enable-avutil --enable-bsfs --enable-swscale --enable-amf --enable-encoder='h264_amf,hevc_amf,av1_amf' --enable-encoder='h264_mf,hevc_mf,av1_mf' --enable-mediafoundation --enable-cuda --enable-encoder='h264_nvenc,hevc_nvenc,av1_nvenc' --enable-ffnvcodec --enable-nvenc --enable-libsvtav1 --enable-encoder=libsvtav1 --enable-libx264 --enable-encoder=libx264 --enable-libx265 --enable-encoder=libx265 --enable-dxva2 --enable-d3d11va --enable-encoder='h264_qsv,hevc_qsv,av1_qsv' --enable-libvpl"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2025
#define FFMPEG_DATADIR "/z/Git/Sunshine-build-deps-dxva2/build/FFmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/z/Git/Sunshine-build-deps-dxva2/build/FFmpeg/share/ffmpeg"
